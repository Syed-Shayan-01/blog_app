      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contentWrapper}>
          <Animated.View
            ...
            <Image
              source={{
                uri: 'https://images.unsplash.com/photo-1536164261511-3a17e671d380',
              }}
          ...
          <Animated.View
            ...
            <View style={styles.card}>
              <Text style={styles.bioText}>
                Tech enthusiast and professional blogger with 10+ years of
                experience. Sharing insights about the latest in technology and
                innovation.
              </Text>
            </View>
              ...
              {[
                ...
                <TouchableOpacity key={index} style={styles.socialItem}>
                  <MaterialIcons
                    ...
                    color={item.color}
                  />
                  <Text style={[styles.socialText, {color: item.color}]}>
                    {item.text}
                  </Text>
                </TouchableOpacity>
              ))}
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    padding: Math.max(width, height) * 0.02,
  },
  userName: {
    fontSize: 28,
    fontWeight: '700',
